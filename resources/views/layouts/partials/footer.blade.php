    ...
    <div class="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="md:col-span-1">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="https://api.whatsapp.com/send?phone=905420000000" target="_blank" rel="noopener" aria-label="WhatsApp"
        ...
        <div>
            ...
            <ul class="space-y-3 text-sm text-white/75 mb-6">
                ...
                <li class="flex items-center gap-2">
                    ...
                    <a href="tel:+905420000000" class="hover:text-white transition-colors">+90 542 000 00 00</a>
                </li>
                <li class="flex items-center gap-2">
                    <svg class="w-4 h-4 flex-shrink-0 text-rg-lavender" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                    </svg>
                    <a href="mailto:info@rosegarden.test" class="hover:text-white transition-colors">info@rosegarden.test</a>
                </li>
            </ul>
            {{-- Payment icons --}}
            <div>
