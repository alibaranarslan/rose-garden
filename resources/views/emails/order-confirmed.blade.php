                ...
                <td style="padding:16px 20px;">
                  @if($order->payment_method === 'bank_transfer')
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                      <tr><td style="font-size:13px;color:#555555;padding:3px 0;">Banka:</td><td style="font-size:13px;color:#333333;padding:3px 12px;">{{ \App\Models\Setting::get('payment', 'bank_name') ?? '—' }}</td></tr>
                      <tr><td style="font-size:13px;color:#555555;padding:3px 0;">Hesap Sahibi:</td><td style="font-size:13px;color:#333333;padding:3px 12px;">{{ \App\Models\Setting::get('payment', 'account_holder') ?? '—' }}</td></tr>
                      <tr><td style="font-size:13px;color:#555555;padding:3px 0;">IBAN:</td><td style="font-size:13px;color:#333333;font-weight:700;padding:3px 12px;">{{ \App\Models\Setting::get('payment', 'iban') ?? '—' }}</td></tr>
                    ...
                    <p style="margin:12px 0 0;font-size:12px;color:#e74c3c;">⚠ Ödemeniz 72 saat içinde alınmazsa siparişiniz otomatik iptal edilecektir.</p>
                  @else
